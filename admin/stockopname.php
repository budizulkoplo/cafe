...
<?php include 'header.php'; ?> <div class="col-12 col-md-12 p-3 p-md-3 bg-white border border-white text-center">
    ...
    <h3 class="text-center">LAPORAN STOCK OPNAME</h3>
    <hr>
    <div class="container">
        <div class="row">
...
<script>
    ...
    function tampildata() {
        $("#tblharian").load("displayopname.php?cmd=display&bulan=" + $('input[name="bulan"]').val());
    }
...
<script type="text/javascript">
    ...
    function exportToPdf() {
        ...
        window.open("opnamepdf.php?bulan=" + $('input[name="bulan"]').val() + "&storeid=" + $('select[name="storeid"]').val());
    ...
    function exportToXLS() {
        ...
        window.open("opnameexcel.php?bulan=" + $('input[name="bulan"]').val() + "&storeid=" + $('select[name="storeid"]').val());
