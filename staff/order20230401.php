    ...
    <div class="col-12 col-md-8 p-3 p-md-3 shadow rounded">
      ...
      <div class="container bg-dark" id="tampilmenu">
        <div class="row">
          ...
          ?>
              <div class="menu col-3"><button class="btn btn-warning" style='width:100%;' onclick="displayItem(<?php echo $menuRow['menuID'] ?>)"><?php echo $menuRow['menuName'] ?> <br><i class="fas fa-utensils"></i></button></div>
      ...
      <div class="card-body">
        <form action="insertorder.php" method="POST">
          ...
          <table width="100%">
            ...
            <tr><td colspan="2"><textarea class="form-control" id="note" name="note" rows="1" cols="50" placeholder="note pesanan..."></textarea></td></tr>
