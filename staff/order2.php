    ...
    <div class="col-12 col-md-4 p-3 p-md-3 shadow rounded">
      ...
      <div class="container bg-dark" id="tampilmenu">
        <div class="row">
          ...
          ?>
              <div class="menu col-4"><button class="btn btn-warning" onclick="displayItem(<?php echo $menuRow['menuID'] ?>)"><?php echo $menuRow['menuName'] ?> <br><i class="fas fa-utensils"></i></button></div>
      ...
      <div class="card-body">
        <form action="insertorder.php" method="POST">
          ...
          <table width="100%">
            ...
            <tr>
              <td>
                <h6>Total</h6><span class="fontkecil">(Total harus dibayar total harga - diskon)</span>
              </td>
            ...
            <tr>
              <td>
                <h6>Bayar</h6><span class="fontkecil"> (Jumlah uang dibayarkan)</span>
              </td>
