    ...
    <div class="col-12 p-3 p-md-5">
        ...
        <form action="addtransaksi.php" method="POST" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
            <div class="input-group">
                ...
                <select name="kategori" id="kategori" class="form-control"> <?php $catpengeluaran = "SELECT namakategori FROM tbl_catpengeluaran where code='1'";
                ...
                <input type="text" required="required" name="namatransaksi" class="form-control" placeholder="Nama Transaksi" aria-label="Add" aria-describedby="basic-addon2">
